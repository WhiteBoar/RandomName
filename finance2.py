...
#    return df
    try:
        ...
        time.sleep(10)
        df.to_csv('C:/Users/KarolUrbanski/OneDrive - northvolt.com/Documents/Finance Python/Finance2' + ticker + '.csv')
...
tickers = get_column_from_csv('C:\Users\KarolUrbanski\Downloads\Wilshire-5000-Stocks-New.csv','Ticker')
